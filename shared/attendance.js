...
// settings/lessonTimes (edited in admins/adminschedule.html). Exported so
// admins/adminschedule.html can compute the exact same sessionCutoffTs this
...
const STYLES = `
  ...
  #attendanceSheet .seg button{flex:1 1 0;min-height:48px;padding:12px 10px;background:transparent;border:0;cursor:pointer;font-weight:900;font-size:1rem;font-family:var(--app-font, "Tajawal", system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif);transition:var(--transition)}
  ...
  #attendanceSheet .select{appearance:none;-webkit-appearance:none;-moz-appearance:none;width:100%;min-height:52px;padding:12px 16px;padding-inline-end:44px;border-radius:16px;font-weight:800;font-size:1rem;cursor:pointer;border:1px solid rgba(3,60,84,.15);background:linear-gradient(145deg,var(--primary),var(--primary-light));color:#fff;box-shadow:0 14px 32px rgba(3,60,84,.25);transition:var(--transition);font-family:var(--app-font, "Tajawal", system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif)}
